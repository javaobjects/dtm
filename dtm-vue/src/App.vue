        ...
        <div class="pull-left" :class="isCollapse ? 'nav-collapse' : 'nav'">
            ...
            >
                <el-row>
                    <el-col :span="5">
                        <img
                            :class="isCollapse ? 'logo-collapse' : 'logo'"
                            src="./assets/logo.png"
                            alt=""
                            @click="to('/')"
                        />
                    </el-col>
                    <el-col :span="19" v-if="!isCollapse" style="margin-top: 15px;color: rgb(64,64,64);font-size: 24px;font-weight: 600;"> 
                        宿舍管理系统
                    </el-col>
                </el-row>
